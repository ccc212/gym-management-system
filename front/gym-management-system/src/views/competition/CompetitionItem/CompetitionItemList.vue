<template>
  <el-main>
    ...
    <el-form :model="searchParm" :inline="true" size="default">
      ...
      <el-form-item style="width: 200px;">
        <el-select v-model="searchParm.category" placeholder="请选择赛事类别" clearable>
          <el-option
      ...
      <el-form-item style="width: 200px;">
        <el-select v-model="searchParm.isTeamCompetition" placeholder="请选择比赛类型" clearable>
          <el-option
    ...
    <el-table :height="tableHeight" :data="tableList" border stripe>
      <el-table-column prop="name" label="项目名称" width="170px"></el-table-column>
      ...
      <el-table-column prop="category" label="赛事类别" width="120px">
        <template #default="scope">
          <el-tag v-if="scope.row.category === 0" type="warning">淘汰赛</el-tag>
          <el-tag v-else-if="scope.row.category === 1" type="info">循环赛</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="isTeamCompetition" label="比赛类型" width="120px">
        <template #default="scope">
          <el-tag v-if="scope.row.isTeamCompetition === 0" type="danger">个人赛</el-tag>
          <el-tag v-else-if="scope.row.isTeamCompetition === 1" type="success">团体赛</el-tag>
        </template>
      </el-table-column>
...
const resetBtn = () => {
  ...
  searchParm.category = null;
  searchParm.isTeamCompetition = null;
  searchParm.page = 1;
};
