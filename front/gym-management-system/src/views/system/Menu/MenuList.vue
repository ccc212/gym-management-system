<template>
    <el-main>
      ...
      <el-form ref="addRef" :model="addModel" :rules="rules" label-width="80px">
        ...
        <el-form-item label="权限字段" prop="code">
            <el-input v-model="addModel.code" placeholder="请输入权限字段"></el-input>
        </el-form-item>
    ...
    <el-dialog title="编辑菜单" v-model="openEdit" width="500px" append-to-body>
      <el-form ref="editRef" :model="editModel" :rules="rules" label-width="80px">
        <el-form-item label="菜单类型" prop="type">
        ...
        <el-form-item label="菜单名称" prop="title">
            <el-input v-model="editModel.title" placeholder="请输入菜单名称"></el-input>
        </el-form-item>
        <el-form-item label="菜单图标" v-if="editModel.type != '2'" prop="icon">
            <el-input v-model="editModel.icon" placeholder="请输入图标"></el-input>
        </el-form-item>
        <el-form-item label="路由名称" v-if="editModel.type != '2'" prop="name">
            <el-input v-model="editModel.name" placeholder="请输入路由名称"></el-input>
        </el-form-item>
        <el-form-item label="菜单序号" prop="orderNum">
            <el-input v-model="editModel.orderNum" placeholder="请输入菜单序号"></el-input>
        </el-form-item>
        <el-form-item label="权限字段" prop="code">
            <el-input v-model="editModel.code" placeholder="请输入权限字段"></el-input>
        </el-form-item>
        <el-form-item label="路由地址" v-if="editModel.type != '2'" prop="path">
            <el-input v-model="editModel.path" placeholder="请输入路由地址"></el-input>
        </el-form-item>
        <el-form-item label="组件路径" v-if="editModel.type == '1'" prop="url">
            <el-input v-model="editModel.url" placeholder="请输入组件路径"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
        <div class="dialog-footer">
...
const treeclick = (item: any) => {
    ...
    } else if (openEdit.value) {
        editModel.parentName = item.title
    }
}
...
function submitFormEdit() {
    editRef.value?.validate(async (valid) => {
        if (valid) {
            let res = await editApi(editModel)
            if (res && res.code == 0) {
                ElMessage.success(res.msg)
                getList()
                openEdit.value = false
